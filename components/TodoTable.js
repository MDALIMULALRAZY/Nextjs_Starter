...
import { Container,Tabs, Row, Tab, Col } from 'react-bootstrap';
  ...
  render() {
    ...
    return (
      <div className="todo-table">
        <Row>
          <Col>
            <Tabs defaultActiveKey="profile" onChange={this.tabKeyToActionType} id="uncontrolled-tab-example" className="mb-3">
              <Tab eventKey="1" title="All"></Tab>
              <Tab eventKey="2" title="Completed"> </Tab>
              <Tab eventKey="3" title="Active"> </Tab>
            </Tabs>
          </Col>
        </Row>
        <Row>
